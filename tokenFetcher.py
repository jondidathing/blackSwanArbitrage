...
def getTokens(txHash:str, blockExplorer:str):
    ...
    match blockExplorer:
        ...
        case 'bscscan.com/tx/':
            # instantiate a web3 remote provider
            endPoint = 'https://bsc.getblock.io/6740c819-7a27-4382-93c2-d029ac4b0a97/mainnet/'
            try:
                w3 = Web3(HTTPProvider(endPoint))
            except Exception as err:
                print(err)
        case 'snowtrace.io/tx/':
            # instantiate a web3 remote provider
            endPoint = 'https://avax.getblock.io/mainnet/6740c819-7a27-4382-93c2-d029ac4b0a97/ext/bc/C/rpc'
            try:
                w3 = Web3(HTTPProvider(endPoint))
            except Exception as err:
                print(err)
